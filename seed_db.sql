...
("печка"				, "пе4ка"													, 420.0 ),
("лестаро телевизор"	, "телевизор леново, ама стар"								, 1337.0),
("ютия"					, "lorem Ipsum dolor sit amet, conseqteur adipiscing elit"	, 69.0  ),
("кабел"				, "кабел (надъвкан)"										, 10.0  ),
("митковълнова печка"	, "ММММММММММММММММММММММММММММММММММММММММММММММММММММММММ", 119.0 ),
("тостер"				, "Аз съм тостер"											, 426.0 );
